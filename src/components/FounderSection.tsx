      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="flex justify-center">
            <div className="relative">
              <img
                ...
                className="rounded-2xl w-72 h-80 object-cover shadow-2xl"
                loading="lazy"
              />
              <div className="absolute -bottom-4 -right-4 w-72 h-80 border-2 border-sky-custom/30 rounded-2xl -z-10" />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-ice/70 leading-relaxed mb-4">
