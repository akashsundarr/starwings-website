      ...
      <div className="relative container mx-auto px-4 pt-20">
        <div className="max-w-3xl">
          ...
          <h1 className="font-heading text-5xl md:text-7xl font-bold text-ice leading-[1.1] mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            Generating{" "}
            <span className="text-green-brand">Superior</span>{" "}
            Comfort
          </h1>

          <p className="text-lg md:text-xl text-ice/85 max-w-xl mb-10 font-body leading-relaxed animate-fade-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 border-2 border-ice/40 text-ice px-8 py-4 rounded-lg font-heading font-semibold text-base hover:bg-accent hover:text-accent-foreground hover:border-accent transition-all"
            >
              Get a Quote
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-20 animate-fade-up" style={{ animationDelay: "0.5s" }}>
          {[
            ...
            <div
              key={stat.label}
              className="flex items-center gap-4 bg-ice/10 backdrop-blur-md rounded-xl p-5 border border-ice/15"
            >
              ...
              <div>
                ...
                <div className="text-ice/65 text-sm font-body">{stat.label}</div>
              </div>
            </div>
          ))}
        </div>
